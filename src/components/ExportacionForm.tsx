...
import { ESTATUS_OPTIONS, FIELD_LABELS } from "@/types/exportacion";
...
export function ExportacionForm({
  action,
  initialValue,
  operativoOptions = [],
  ...
  const isLCLE = typeValue.trim().toUpperCase() === "LCLE";
  const isFCLE = typeValue.trim().toUpperCase() === "FCLE";
